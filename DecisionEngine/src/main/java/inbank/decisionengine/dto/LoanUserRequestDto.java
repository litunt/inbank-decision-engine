...
import static inbank.decisionengine.utils.constants.DecisionValueConstants.MAX_ALLOWED_LOAN_INT;
import static inbank.decisionengine.utils.constants.DecisionValueConstants.MAX_PERIOD;
import static inbank.decisionengine.utils.constants.DecisionValueConstants.MIN_ALLOWED_LOAN_INT;
...
public record LoanUserRequestDto(
    ...
    @NotNull(message = VALIDATION_ERR_EMPTY)
    @Min(value = MIN_ALLOWED_LOAN_INT, message = VALIDATION_ERR_MIN_VALUE)
    @Max(value = MAX_ALLOWED_LOAN_INT, message = VALIDATION_ERR_MAX_VALUE)
